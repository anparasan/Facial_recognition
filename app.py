...
st.sidebar.image('https://i.ibb.co/YDLG0bp/logocctv.jpg',
                 use_column_width=False)
st.sidebar.markdown("""
                    > Made by [*Anparasanesan Tharmarajah*](https://www.linkedin.com/in/anparasanesan/)
                    """)

user_color      = '#217eaa'
title_webapp    = "Visitor Watch Pro"
...
def main():
    ...
    st.sidebar.info("Visitor Watch Pro is a cutting-edge application designed to seamlessly monitor "
                    "and manage visitor access with advanced facial recognition technology")
    ###################################################
